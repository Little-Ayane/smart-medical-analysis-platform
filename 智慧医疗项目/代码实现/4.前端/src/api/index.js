...
export default {
  ...
  getDrgCostRankingApi(params) {
    ...
    return api.get('/drg/cost-ranking', { params })
  },
  getDrgStayComparison(params) {
    ...
    return api.get('/drg/stay-comparison', { params })
  },
  getDrgMortalityRisk(params) {
    ...
    return api.get('/drg/mortality-risk', { params })
  },
  getDrgCmiRanking(params) {
    ...
    return api.get('/drg/cmi-ranking', { params })
  },
  getDrgOutlierDetection(params) {
    ...
    return api.get('/drg/outlier-detection', { params })
  },
