  ...
  try {
    ...
    if (tabKey === 'top-diagnoses') {
      ...
      option = {
        tooltip: { trigger: 'axis' },
        grid: { left: '6%', right: '4%', top: '8%', bottom: '18%' },
        xAxis: { type: 'category', data: groups, axisLabel: { rotate: 15 } },
        yAxis: { type: 'value', name: '人数' },
        legend: { top: 0, data: severities, textStyle: { color: '#8ab4d6' } },
        series
      }
      ...
      option = {
        ...
        xAxis: { type: 'category', data: data.map(d => d.key), name: '分组' },
        yAxis: { type: 'value', name: '人数' },
      ...
      option = {
        ...
        yAxis: { type: 'category', data: dim2s },
