  ...
  <div class="dashboard">
    ...
    <div class="header">
      ...
      <div class="header-right">
        ...
        <!-- 3D 大屏入口按钮 -->
        <button class="menu-btn bigscreen-btn" @click="goBigScreen" style="margin-left: 12px;">
          <span class="menu-icon">🌐</span>
          <span class="menu-label">3D 大屏</span>
        </button>
        <!-- 右上角下拉菜单：6 个图表模块 -->
...
const goBigScreen = () => { router.push('/bigscreen') }
...
function initDisease() {
  ...
  const chart = echarts.init(chartDiseaseRef.value, 'medical', { devicePixelRatio: 1 })
  chart.setOption({
    tooltip: { show: false },
...
function initPayment() {
  ...
  const chart = echarts.init(chartPaymentRef.value, 'medical', { devicePixelRatio: 1 })
  chart.setOption({
    tooltip: { show: false },
    legend: {
...
function initHospital() {
  ...
  const chart = echarts.init(chartHospitalRef.value, 'medical', { devicePixelRatio: 1 })
  chart.setOption({
    tooltip: { show: false },
...
function initQuality() {
  ...
  const chart = echarts.init(chartQualityRef.value, 'medical', { devicePixelRatio: 1 })
  chart.setOption({
    tooltip: { show: false },
...
function initEmergency() {
  ...
  const chart = echarts.init(chartEmergencyRef.value, 'medical', { devicePixelRatio: 1 })
  chart.setOption({
    tooltip: { show: false },
    legend: {
      top: 4, right: 10,
...
function initCost() {
  ...
  const chart = echarts.init(chartCostRef.value, 'medical', { devicePixelRatio: 1 })
  chart.setOption({
    tooltip: { show: false },
    visualMap: {
      show: false,
